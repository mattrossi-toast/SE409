...
var myRectangle = Rectangle(width:2, height: 4)
...
var someonesHeight = Height(heightInCentimeters: 200)
print(someonesHeight.heightInInches, someonesHeight.heightInCentimeters)
someonesHeight.heightInCentimeters = 400
print(someonesHeight.heightInInches, someonesHeight.heightInCentimeters)
