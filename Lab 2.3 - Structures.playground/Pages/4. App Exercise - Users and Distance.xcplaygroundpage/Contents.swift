 ...
 */
var matt = User(name:"Matt", age: 22, height: 71, weight:180, activityLevel: 0)

print("My name is \(matt.name), I am \(matt.age), I am \(matt.height) inches tall, and \(matt.weight)lbs. I have an activity level of \(matt.activityLevel)")
/*:
...
struct Distance {
    ...
    init(distanceInFeet: Double){
        self.meters = distanceInFeet / 3.28084
 ...
 */
var newDist = Distance(distanceInFeet: 1)
print(newDist.feet, newDist.meters)
